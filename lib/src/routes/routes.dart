...
import 'package:myeventphoto_mobile_client/src/views/pages/compras/carrito_page.dart';
import 'package:myeventphoto_mobile_client/src/views/pages/compras/compras_page.dart';
import 'package:myeventphoto_mobile_client/src/views/pages/compras/mis_compras_page.dart';
import 'package:myeventphoto_mobile_client/src/views/pages/compras/pago_page.dart';
...
Map<String, WidgetBuilder> getApplicationRoutes() {
  return <String, WidgetBuilder>{
    ...
    '/cliente/compras': (BuildContext context) => ComprasPage(),
    '/invitado/compras/fotos': (BuildContext context) => MisComprasPage(),
    '/invitado/carrito/fotos': (BuildContext context) => CarritoDeComprasPage(),
    '/invitado/pago/fotos': (BuildContext context) => PagoPage(),
